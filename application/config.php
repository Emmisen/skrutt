 ...
 * Define menus.
 *
 * Create hardcoded menus and map them to a theme region through $sk->config['theme'].
 */
$sk->config['menus'] = array(
  'navbar' => array(
 ...
 * Template files can reside in the parent or current theme, the CSkrutt::ThemeEngineRender()
 ...
 *
 * path: Path to current theme, relativly SKRUTT_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
