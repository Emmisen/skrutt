...
class CMModules extends CObject {
   ...
   * Properties
   */
  private $skruttCoreModules = array('CSkrutt', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $skruttCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isSkruttCore']   = in_array($rc->name, $this->skruttCoreModules);
      $details['isSkruttCMF']    = in_array($rc->name, $this->skruttCMFModules);
