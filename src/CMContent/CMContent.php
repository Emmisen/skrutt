...
class CMContent extends CObject implements IHasSQL, ArrayAccess {
  ...
  public function Init() {
    try {
      ...
      $this->db->ExecuteQuery(self::SQL('insert content'), array('bbcode', 'page', 'Page with BBCode', "This is a demo page with some BBCode-formatting.\n\n[b]Text in bold[/b] and [i]text in italic[/i] and [url=http://dbwebb.se]a link to dbwebb.se[/url]. You can also include images using bbcode, such as the skrutt logo: [img]http://www.student.bth.se/~embj12/phpmvc/kmom05/skrutt/themes/core/img/skrutt.png[/img]", 'bbcode', $this->user['id']));
